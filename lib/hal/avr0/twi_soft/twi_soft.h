...
#define TWI_SOFT_H_
     ...
     * @{
     */
    #define SCL_LOW()  { TWI_SOFT_PORT.OUTCLR = TWI_SOFT_SCL; TWI_SOFT_PORT.DIRSET = TWI_SOFT_SCL; }
    #define SDA_LOW()  { TWI_SOFT_PORT.OUTCLR = TWI_SOFT_SDA; TWI_SOFT_PORT.DIRSET = TWI_SOFT_SDA; }
    #define SCL_HIGH() { TWI_SOFT_PORT.DIRCLR = TWI_SOFT_SCL; TWI_SOFT_PORT.OUTCLR = TWI_SOFT_SCL; }
    #define SDA_HIGH() { TWI_SOFT_PORT.DIRCLR = TWI_SOFT_SDA; TWI_SOFT_PORT.OUTCLR = TWI_SOFT_SDA; }
    /** @} */
